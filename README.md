...
> 🎬 **Vidéo démo** : [Regarder sur YouTube](#) | 📱 **Télécharger l'APK** : [Releases](https://github.com/faceoff2003/baccalaureat-flutter/releases) | 🌐 **Web App** : [Jouer en ligne](https://ton-url.web.app)
